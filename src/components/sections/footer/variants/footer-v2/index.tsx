      ...
      <div className="relative overflow-hidden">
        <div className="flex flex-col gap-16 lg:gap-10">
            ...
            <div className="flex w-full flex-col gap-10 lg:w-190 lg:flex-row lg:items-start lg:justify-between">
              <div className="grid grid-cols-2 lg:contents">
                ...
                <div className="flex w-full flex-col gap-5 text-base leading-normal font-normal lg:w-50">
                  ...
                  <Link href="#rooms" className="opacity-80 hover:opacity-100">
                    {footer.links.rooms}
                  </Link>
                  <Link
                    href="#gallery"
              ...
              <div className="flex w-full flex-col gap-5 lg:w-75">
                ...
                <div className="flex w-full flex-col gap-3">
                  {/* Email Button */}
                  <div className="border-foreground/50 bg-foreground/0 hover:bg-foreground/10 flex w-full items-center justify-between gap-3 border border-solid px-5 py-3 transition-colors">
                  ...
                  <div className="border-foreground/50 bg-foreground/0 hover:bg-foreground/10 flex w-full items-center justify-between gap-3 border border-solid px-5 py-3 transition-colors">
                    <div className="flex items-center gap-3">
                      <PhoneIcon size={24} className="shrink-0 text-current" />
                      <p className="text-base leading-normal font-normal">
                  ...
                  {Object.entries(hotelProfile.social).map(([key, url]) => {
                    ...
                    return (
                      <a
                        ...
                        className="bg-accent hover:bg-accent/80 flex size-8 items-center justify-center overflow-hidden rounded-full transition-colors"
                      >
                        <IconComponent />
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-foreground relative h-px w-full overflow-hidden opacity-20"></div>
            <div className="flex flex-col-reverse items-start gap-6 lg:flex-row lg:justify-between">
              ...
              <div className="flex flex-col gap-3">
                <p className="text-sm leading-normal font-normal opacity-60">
                  {footer.credits}
                </p>
                <a
