  ...
  return (
    <section className="bg-background relative z-10 flex h-svh w-full flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant={"outline-primary"} asChild className="lg:hidden">
              <a
                href="#enquiry-form"
                onClick={() =>
                  track("cta-enquiry-mobile", { route: "/kulinarik" })
                }
              >
                {nav.enquiryNow}
              </a>
            ...
            >
              <a
                href="#enquiry-form"
                onClick={() =>
                  track("cta-enquiry-desktop", { route: "/kulinarik" })
                }
              >
                {nav.enquiryNow}
              </a>
      ...
      <div className="relative flex flex-1 flex-col">
        <div className="flex h-full flex-col gap-5 px-4 py-5 lg:py-6 2xl:gap-10 2xl:py-14">
          {/* Title and Description Row */}
          <div className="flex gap-30">
            <div className="flex-1">
              <h1 className="font-title text-display-2 text-center font-normal lg:text-start">
                {hero.title}
              </h1>
            </div>
          </div>
